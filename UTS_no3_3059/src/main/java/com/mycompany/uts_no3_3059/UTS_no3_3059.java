 ...
 */
public class UTS_no3_3059 {

    public static void main(String[] args) {
        //Membuat object menggunakan array
        AsistenPraktikum_3059[] ap = new AsistenPraktikum_3059[1];
        StudentStaff_3059[] ss = new StudentStaff_3059[1];
        
        ap[0] = new AsistenPraktikum_3059();
        ss[0] = new StudentStaff_3059();
